...
<body>
	...
	<div class="wrap">
		<div class="container">
				<h2 align="center">Data Verifikasi</h2>

	<table id="example" class="table table-striped table-bordered" style="width:100%">
     
		<tr style="background-color: #A9A9A9">
			<center><a href="verifikasi.php" class="btn btn-success">Tambah Data</a></center>
			<br>
		...
		$no=1;
		$tampil=mysql_query("SELECT * FROM tb_verifikasi");
		...
		<tr style="color: black;">
			...
			<td>
				<a href="formedit.php?id_verifikasi=<?php echo $data['id_verifikasi'] ?>">Ubah</a>
				<a href="hapus.php?id_verifikasi=<?php echo $data['id_verifikasi'] ?>">Hapus</a>
			</td>
		</tr>
		<?php
		}
