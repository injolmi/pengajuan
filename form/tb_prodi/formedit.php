...
$edit = mysqli_query($koneksi,"select * from tb_prodi where id_prodi='$id_prodi'");
...
<div class="w-50 mx-auto border p-3 mt-5">
  <h4 class="mb"><i class="fa fa-angle-right"></i> Edit Data Mahasiswa</h4>
    <form action="edit.php" method="POST">
      ...
      <input type="text" name="id_prodi" class="form-control" value="<?php echo $data['id_prodi'];?>" readonly>
