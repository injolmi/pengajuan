...
<body>
	...
	<div class="wrap">
		...
		<tr style="background-color: #A9A9A9">
			<center><a href="prodi.php" class="btn btn-success">Tambah</a></center>
			<br>
			<td align="center">No</td>
			<td align="center">Id Prodi</td>
		...
		$no=1;
				$tampil = mysqli_query($koneksi,"select * from tb_prodi");
		while($data = mysqli_fetch_array($tampil)){
		?>
		<tr style="color: black;">
			<td align="center"><?php echo $no++;?></td>
			<td align="center"><?php echo $data['id_prodi'];?></td>
			<td align="center"><?php echo $data['prodi'];?></td>
			<td align="center">
				<a href="formedit.php?id_prodi=<?php echo $data['id_prodi'] ?>">Ubah</a> |
				<a href="hapus.php?id_prodi=<?php echo $data['id_prodi'] ?>">Hapus</a>
			</td>
		</tr>
		<?php
		}
