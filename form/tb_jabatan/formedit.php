...
$edit = mysqli_query($koneksi,"select * from tb_jabatan where id_jabatan='$id_jabatan'");
...
<div class="w-50 mx-auto border p-3 mt-5">
  <h4 class="mb"><i class="fa fa-angle-right"></i> Edit Data Mahasiswa</h4>
    <form action="edit.php" method="POST">
      ...
      <input type="text" name="id_jabatan" class="form-control" value="<?php echo $data['id_jabatan'];?>" readonly>
